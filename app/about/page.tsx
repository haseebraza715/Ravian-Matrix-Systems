      ...
      <section className="py-24 border-b border-line bg-bg">
        <div className="max-w-[800px] mx-auto px-8">
          <div className="prose prose-lg text-ink-2">
            <h2 className="text-3xl font-medium text-ink tracking-tight mb-6">Our positioning</h2>
            <p className="mb-6">
            ...
            <h2 className="text-3xl font-medium text-ink tracking-tight mb-6 mt-12">How we think about geospatial systems</h2>
            <p className="mb-6">
            ...
            <h2 className="text-3xl font-medium text-ink tracking-tight mb-6 mt-12">Why structured outputs matter</h2>
            <p className="mb-6">
            ...
            <h2 className="text-3xl font-medium text-ink tracking-tight mb-6 mt-12">Serving clients worldwide</h2>
            <p>
