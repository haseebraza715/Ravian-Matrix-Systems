...
export const en: Translations = {
  common: {
    ...
    requestNonBindingQuote: "Request a Non-Binding Quote",
    ...
    phone: "Phone",
    location: "Location",
    responseNote: "We usually respond within 24 hours on business days.",
    allRightsReserved: "All rights reserved.",
    impressum: "Impressum",
    privacyPolicy: "Privacy Policy",
    chevronBackToHome: "Home",
    error404: "Error 404",
    signalLost: "Signal Lost",
    notFoundDesc: "The page or coordinate you are looking for does not exist in our spatial database.",
  ...
  hero: {
    ...
    titleHtml: "Custom Software, GIS &amp; Web Solutions in <span class=\"text-gold\">Munich</span>",
    description: "We build professional web systems, custom software, GIS solutions, and digital growth strategies for businesses worldwide. From web applications and automation to geospatial analysis and branding, we turn your requirements into scalable, results-driven digital solutions."
  },
  kpi: {
    coreServices: {
      label: "Core Services",
      detail: "Web, Software, Geospatial, Digital Growth"
    },
    languages: {
      label: "Languages",
      detail: "English and German support"
    },
    responseTime: {
      label: "Response Time",
      detail: "Business day initial reply"
    }
  },
  serviceStrip: {
    eyebrow: "Capabilities",
    title: "Web GIS · Custom Systems · Remote Sensing · Automation · Branding"
  },
  intro: {
    eyebrow: "Who We Are",
    titleHtml: "Scalable Solutions for <span class=\"text-gold\">Global Digital Business Needs</span>",
    desc: "At Ravian Matrix Systems, we provide integrated technical and digital services for businesses, startups, organizations, and project teams.",
    p1: "Our work combines software development, web solutions, geospatial intelligence, data handling, automation, and creative digital communication. We focus on building solutions that are clear, functional, reliable, and aligned with real business needs.",
    p2: "Whether you need a professional website, a custom application, spatial analysis, digital branding, or process automation, we help define the right solution and deliver it with a structured approach."
  },
  coreServices: {
    titleHtml: "Our Core <span class=\"text-gold\">IT &amp; GIS Services</span>",
    desc: "Explore our core services, from custom web development and software engineering to GIS consulting and digital growth strategies. Each is built for businesses that need reliable, scalable technology solutions.",
  ...
  whyWorkWithUs: {
    titleHtml: "Why Global Businesses Choose <span class=\"text-gold\">Ravian Matrix Systems</span>",
    desc: "Five reasons clients trust us for structured digital, software, and GIS project delivery.",
    reasons: [
      {
  ...
  valueDeliver: {
    eyebrow: "Our Project Capabilities",
    titleHtml: "Web, Software &amp; GIS Projects <span class=\"text-gold\">We Deliver</span>",
    description: "From custom web platforms and enterprise software to geospatial dashboards and digital campaigns, we deliver everything with perfection.",
    items: [
      "Company Websites",
  ...
  serviceHighlights: {
    ...
    languagesLead: "We communicate with clients in English and German.",
    languagesBody1: "You can contact us through email or the quote form. After reviewing your inquiry, we can arrange a call, virtual meeting, or in-person discussion if required.",
    languagesBody2: "We respond within 24 hours with a non-binding quote.",
    appointmentLabel: "Available by appointment"
  },
  processSection: {
    eyebrow: "Process",
  ...
  cta: {
    ...
    desc: "Tell us what you need, and we will help define the right approach. We respond within 24 hours with a non-binding quote.",
    button: "Request a Quote"
  },
  footer: {
    slogan: "You name IT, We make IT.",
    description: "Delivering reliable IT, web, geospatial, and digital solutions for businesses in Germany, Europe, and worldwide.",
    ...
    emailLabel: "EML:",
    hoursLabel: "HRS:",
    hoursDesc: "Response within 24 hours on business days. Meetings by appointment only.",
    languageLabel: "LNG:",
    languagesSupported: "English & German",
    quoteLabel: "QTE:",
    quoteDesc: "Non-binding and free of charge"
  },
  about: {
    ...
    whoWeAreSubhead: "A Technical Service Partner for Digital and Spatial Solutions",
    whoWeAreParagraphs: [
    ...
    foundationDesc: "Mission, vision, and values from the source material that define how we work and how we communicate.",
    foundationCards: [
      {
        title: "Our Mission",
        body: "To deliver reliable IT, web, geospatial, and digital solutions that help businesses operate better, present themselves professionally, and make smarter use of data and technology."
      },
      {
        title: "Our Vision",
        body: "To become a trusted technical service provider for businesses in Germany, Europe, and international markets by delivering structured, practical, and scalable digital solutions."
      },
      {
        title: "Our Values",
        body: "We focus on clarity, reliability, practical execution, and professional communication. Every project should be useful, understandable, and aligned with the client’s real requirements."
      }
    ],
    teamTitle: "Our Team",
    teamDesc: "Our team brings together selected specialists across geospatial intelligence, software development, digital growth, and client communication.",
    teamCoordinationNote: "Project communication, coordination, and delivery are managed through Ravian Matrix Systems in Munich to ensure clear responsibility, structured execution, and consistent quality.",
    teamMembers: [
      {
        name: "Arslan Saleem",
      ...
      },
      {
        ...
        initials: "QR",
        description: "Qamar leads application development, with a focus on custom applications, backend systems, frontend systems, API integration, and digital platform development."
      },
      {
        name: "Sidra Noor",
        role: "Geospatial Intelligence Lead",
        initials: "SN",
        description: "Sidra leads geospatial and remote sensing work, with specialization in GIS, spatial data processing, mapping, environmental analysis, and remote sensing interpretation."
      },
      {
        name: "Waqas Mubarik",
        role: "Digital Growth Lead",
        initials: "WM",
        description: "Waqas leads digital marketing, online visibility, SEO, content direction, and campaign support. His focus is on helping businesses improve their digital presence and brand communication."
      }
    ],
    coordinationTitle: "Project Coordination",
    coordinationDesc: "Ravian Matrix Systems remains the central point of contact for each project. We manage requirement review, communication, coordination, quality control, and delivery through our business structure.",
    whyWorkWithUsTitle: "Why Work With Us",
    whyWorkWithUsSubhead: "Practical, Flexible, and Requirement-Based",
    ...
    communicationSubhead: "English and German Support",
    communicationDesc: "We communicate with clients in English and German. Initial inquiries are handled through the contact form or email. After reviewing the request, we can arrange a call, virtual meeting, or in-person discussion by appointment."
  },
  contact: {
    eyebrow: "Contact Us",
    ...
    infoDesc: "Use this page for general inquiries, business communication, partnership discussions, or questions about our services.",
    formEyebrow: "Send Us a Message",
    formTitle: "Send Us a Message",
    formDesc: "Use this form for general inquiries, business communication, partnership discussions, or questions about our services.",
    processEyebrow: "Process",
    processTitle: "What happens <span class=\"text-gold\">next?</span>",
    processSteps: [
      {
    ...
    estimateEyebrow: "Need a Project Estimate?",
    estimateTitle: "For project scope, pricing, and timelines, please use our Request a Quote page."
  },
  quote: {
    ...
    formEyebrow: "Request a Non-Binding Quote",
    formTitle: "Use this form to describe your project needs.",
    formDesc: "The more details you provide, the better we can understand your requirements and prepare a suitable proposal.",
    processEyebrow: "What Happens Next?",
    processTitle: "Quote request <span class=\"text-gold\">process</span>",
    processSteps: [
      {
    ...
    generalEyebrow: "Need General Information?",
    generalTitle: "For general questions, business inquiries, partnerships, or non-project communication, please use the Contact Us page."
  },
  form: {
    ...
    attachmentLimit: "PDF, DOC, DOCX, PNG, or JPG — max 10 MB.",
    attachmentNotePlaceholder: "Add a link or note about project briefs, screenshots, documents, maps, references, or technical materials if available.",
    company: "Company / Organization",
    serviceRequired: "Service Required",
    projectType: "Project Type",
    projectDetails: "Project Details",
    projectDetailsPlaceholder: "Tell us about your project, goals, required features, target users, data, technical needs, or any specific requirements.",
    expectedTimeline: "Expected Timeline",
    estimatedBudget: "Estimated Budget",
    consentPrefix: "I agree that my submitted data will be processed for the purpose of reviewing my request and preparing a non-binding quote. Further information can be found in the ",
    consentLink: "Privacy Policy",
    consentSuffix: ".",
    successContact: "Message sent successfully!",
    successQuote: "Quote request submitted",
    servicesList: [
      "Web Solutions",
  ...
  servicesOverview: {
    ...
    sectionTitle: "Structured service categories",
    paragraphs: [
  ...
  serviceDetail: {
    builtAroundRequirements: "Built Around Your Requirements",
    whatWeProvide: "What We Provide",
    approach: "Approach",
    suitableFor: "Suitable For",
    howWeWork: "How We Work",
    requestQuote: "Request a Non-Binding Quote",
    stepLabel: "Step"
  },
  work: {
    eyebrow: "Portfolio",
    ...
    categories: ["All", "Geospatial", "Web Applications", "Cloud & Backend"],
    requestDetails: "Request Architecture Details",
    projects: [
      {
        id: "ndvi-agtech",
  ...
  seo: {
    ...
    work: {
      title: "Case Studies | Ravian Matrix Systems",
      description: "Explore concrete digital and geospatial solutions we engineered for our enterprise partners, featuring key performance metrics."
    },
    contact: {
