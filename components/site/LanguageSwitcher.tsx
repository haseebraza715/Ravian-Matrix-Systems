...
export default function LanguageSwitcher() {
  ...
  return (
    <div 
      className="inline-flex items-center bg-[#0B1220]/80 backdrop-blur-md border border-[#1E2A40] rounded-lg p-1"
      role="group" 
      ...
      {locales.map((loc) => {
        ...
        return (
          <button
            ...
            className={`font-mono text-[10px] sm:text-[11px] tracking-wider uppercase px-2.5 py-1 rounded-md transition-all duration-300 focus:outline-none focus:ring-1 focus:ring-[#F5C56B]/50 ${
              isActive
