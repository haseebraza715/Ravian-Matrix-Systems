          ...
          <div>
            ...
            <div className="flex gap-3 mt-6">
              {[
                ...
                <a key={idx} href="#" className="w-9 h-9 rounded-lg bg-white/[0.03] border border-white/10 flex items-center justify-center text-white/60 hover:text-gold hover:border-gold/30 hover:shadow-[0_0_15px_rgba(201,162,77,0.1)] transition-all">
                  <svg width="16" height="16" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true"><path d={social.path}/></svg>
                </a>
              ))}
            </div>
          </div>
