...
export default function IntroSection() {
  ...
  return (
    <section className="py-20 sm:py-32 bg-bg-surface relative overflow-hidden" ref={ref} style={{ borderBottom: '1px solid var(--line-soft)' }}>
      <div className="max-w-[1280px] mx-auto px-6 sm:px-8 relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-[1fr_1.3fr] gap-12 lg:gap-20 items-start">
          <div>
            <div className="reveal eyebrow mb-6">Intro Section</div>
            <h2 className="reveal reveal-delay-1 text-[32px] sm:text-[46px] leading-[1.08] font-bold text-primary mb-6">
              Structured Solutions for <span className="text-gold">Digital Business Needs</span>
            </h2>
